      ...
      if (action === "scan-downloads") {
        ...
        (function () {
          ...
          if (cleanable.length === 0) {
            if (stb)
              stb.textContent = "No cleanable files found";
            return;
          }
          ...
          document.getElementById("cleanup-close").onclick =
            function () {
              panel.style.display = "none";
              if (stb) stb.textContent = "Ready";
            };
          document.getElementById("cleanup-select-all").onclick =
            function () {
              ...
              const someUnchecked = Array.from(cbs).some(function (
                cb,
              ) {
                return !cb.checked;
              });
